...
const renderBootstrapError = (error: unknown) => {
  ...
  container.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,#3a3a37 0%,#30302E 48%,#262624 100%);padding:24px;font-family:'Segoe UI Variable','Segoe UI',system-ui,sans-serif;">
